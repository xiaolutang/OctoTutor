  ...
  return (
    <div className={`group flex ${isUser ? 'justify-end' : 'justify-start'} mb-4`}>
      <div className="relative max-w-[80%]">
        ...
        {/* 操作按钮 - hover 显示 */}
        {isTerminal && (
          <div className={`absolute ${isUser ? 'left-0 -translate-x-full mr-2' : 'right-0 translate-x-full ml-2'} top-0 flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity`}>
            {!isUser && (
              <>
                <button
                  onClick={handleCopy}
